...
public class PanelEmpCentro extends JPanel {
	private static final long serialVersionUID = 1L;
	private JComboBox<String> desplegable;
	private JButton utilidad;

	public PanelEmpCentro(String tipo, VentanaEmpleados ventanaEmpleados) {
		...
		desplegable.addActionListener(ventanaEmpleados);
		utilidad.addActionListener(ventanaEmpleados);
	}
